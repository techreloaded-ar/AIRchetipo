...
Comprehensive guide to AIRchetipo's document sharding system for managing large planning and architecture documents.
...
AIRchetipo workflows use a **dual discovery system**:
...
**All AIM workflows support both formats:**
...
- [AIM Workflows Guide](../src/modules/aim/workflows/README.md) - Workflow overview
- [Workflow Creation Guide](../src/modules/aib/workflows/create-workflow/workflow-creation-guide.md) - Custom workflow patterns
