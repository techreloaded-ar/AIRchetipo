...
This document defines the standard for IDE-specific content injection in AIRchetipo modules. Each IDE can inject its own specific content into AIRchetipo templates during installation without polluting the source files with IDE-specific code. The installation process is interactive, allowing users to choose what IDE-specific features they want to install.
...
## Example: AIM Module with Claude Code
...
injections:
  ...
  - file: '{air_folder}/aim/templates/prd.md'
