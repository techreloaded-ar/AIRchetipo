...
class IdeManager {
  ...
  /**
   * Set the air folder name for all IDE handlers
  ...
  setAirFolderName(airFolderName) {
    ...
    for (const handler of this.handlers.values()) {
      if (typeof handler.setAirFolderName === 'function') {
        handler.setAirFolderName(airFolderName);
      }
    }
  }
   ...
   */
  async setup(ideName, projectDir, airDir, options = {}) {
    ...
    try {
      await handler.setup(projectDir, airDir, options);
