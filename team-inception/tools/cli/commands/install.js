...
module.exports = {
  command: 'install',
  description: 'Install AIRchetipo agents and tools',
  options: [],
  action: async () => {
    try {
      ...
      if (result && result.success) {
        ...
        console.log(chalk.cyan('AIRchetipo and Selected Modules have been installed to:'), chalk.bold(result.path));
        console.log(chalk.yellow('\nThank you for helping test the early release version of the new AIRchetipo Core and AIRchetipo!'));
