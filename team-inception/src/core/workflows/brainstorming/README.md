...
The workflow leverages configuration from `{air_folder}/core/config.yaml`:
...
- Access to the core module configuration (`{air_folder}/core/config.yaml`)
...
- Follow AIRchetipo documentation standards for workflow customization

---

_Part of the AIRchetipo v6 - CORE Framework_
