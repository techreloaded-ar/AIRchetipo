...
<critical>You MUST have already loaded and processed: {project_root}/{air_folder}/core/workflows/brainstorming/workflow.yaml</critical>
...
<invoke-task halt="true">{project-root}/{air_folder}/core/tasks/advanced-elicitation.xml</invoke-task>
