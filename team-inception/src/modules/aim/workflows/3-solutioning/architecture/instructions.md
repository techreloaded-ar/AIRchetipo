...
<check if="status file not found">
  <output>No workflow status file found. Create Architecture can run standalone or as part of AIM workflow path.</output>
...
<action>Save document to {output_folder}/architecture.md</action>
  ...
  <check if="standalone_mode != true">
    ...
    <action>Update workflow_status["create-architecture"] = "{output_folder}/aim-architecture-{{date}}.md"</action>
