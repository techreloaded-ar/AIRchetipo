...
<check if="standalone_mode != true">
  ...
  <action>Update workflow_status["research"] = "{output_folder}/aim-research-{{research_mode}}-{{date}}.md"</action>
...
- Research report generated and saved to {output_folder}/aim-research-{{research_mode}}-{{date}}.md
...
- **Optional:** Review findings with stakeholders, or run additional analysis workflows (product-brief for software, or install AIGD module for game-brief)
