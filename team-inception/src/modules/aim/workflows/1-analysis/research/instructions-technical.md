...
<check if="standalone_mode != true">
  ...
  <action>Update workflow_status["research"] = "{output_folder}/aim-research-technical-{{date}}.md"</action>
...
- Technical research report generated and saved to {output_folder}/aim-research-technical-{{date}}.md
