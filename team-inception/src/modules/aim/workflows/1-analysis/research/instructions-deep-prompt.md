...
<check if="standalone_mode != true">
  ...
  <action>Update workflow_status["research"] = "{output_folder}/aim-research-deep-prompt-{{date}}.md"</action>
...
- Structured research prompt generated and saved to {output_folder}/aim-research-deep-prompt-{{date}}.md
