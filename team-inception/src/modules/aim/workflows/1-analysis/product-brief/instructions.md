...
<check if="standalone_mode != true">
  ...
  <action>Update workflow_status["product-brief"] = "{output_folder}/aim-product-brief-{{project_name}}-{{date}}.md"</action>
...
**Document saved:** {output_folder}/aim-product-brief-{{project_name}}-{{date}}.md
