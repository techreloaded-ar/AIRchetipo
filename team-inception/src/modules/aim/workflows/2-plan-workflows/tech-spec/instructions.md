...
<check if="status file not found">
  <output>No workflow status file found. Tech-spec workflow can run standalone or as part of AIM workflow path.</output>
...
Enter **1** for single story, or **2-5** for number of stories you estimate</ask>
    ...
    <action>Validate: If not 1-5, ask for clarification. If > 5, suggest using full AIRchetipo instead</action>
