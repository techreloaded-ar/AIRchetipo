...
Quick answers to common questions about the AIRchetipo Module.
...
1. Install AIRchetipo: `npx airchetipo@alpha install`
...
**A:** Check your `aim-workflow-status.md` file (created by workflow-init). It shows your current phase and progress. If you don't have this file, you can also tell by what you're working on:
...
AIM respects your choice - it won't force modernization, but it will offer it.
...
All AIM docs use valid Mermaid syntax that should render in GitHub, VS Code, and most IDEs.

### Q: Can I use AIM with GitHub Copilot / Cursor / other AI tools?

**A:** Yes! AIM is complementary. AIM handles:
...
### Q: What IDEs/tools support AIM?

**A:** AIM requires tools with **agent mode** and access to **high-quality LLM models** that can load and follow complex workflows, then properly implement code changes.
...
- **Claude Code** ⭐ **Best choice**
  ...
  - Native agent mode designed for AIM workflows
...
**Why model quality matters:** AIM workflows require LLMs that can follow multi-step processes, maintain context across phases, and implement code that adheres to specifications. Tools with weaker models will struggle with workflow adherence and code quality.

See [IDE Setup Guides](https://github.com/airchetipo-org/AIRchetipo/tree/main/docs/ide-info) for configuration specifics.

### Q: Can I customize agents?

**A:** Yes! Agents are installed as markdown files with XML-style content (optimized for LLMs, readable by any model). Create customization files in `{air_folder}/_cfg/agents/[agent-name].customize.yaml` to override default behaviors while keeping core functionality intact. See agent documentation for customization options.
...
### Q: Can I use AIM for non-software projects?

**A:** AIM is optimized for software development, but the methodology principles (scale-adaptive planning, just-in-time design, context injection) can apply to other complex project types. You'd need to adapt workflows and agents for your domain.
...
Trust your expertise - AIM supports your decisions.

### Q: Can multiple developers work on the same AIM project?
...
**With AIM + AI agents:** A single dev can complete an entire epic in 1-3 days. What used to take months now takes days.
...
- Use **git submodules** for AIM installation (not .gitignore)
...
- Use git submodules for AIM in enterprise settings
...
**A:** Party mode is a unique multi-agent collaboration feature where ALL your installed agents (from AIM, AIB, custom modules) discuss your challenges together in real-time.
...
3. Open a [GitHub Issue](https://github.com/airchetipo-org/AIRchetipo/issues)
4. Watch [YouTube Tutorials](https://www.youtube.com/@AIRchetipoCode)

### Q: How do I report a bug or request a feature?

**A:** Open a GitHub issue at: https://github.com/airchetipo-org/AIRchetipo/issues

Please include:

- AIM version (check your installed version)
...
- [Quick Start Guide](./quick-start.md) - Get started with AIM
...
**Have a question not answered here?** Please [open an issue](https://github.com/airchetipo-org/AIRchetipo/issues) or ask in [Discord](https://discord.gg/gk8jAdXWmj) so we can add it!
