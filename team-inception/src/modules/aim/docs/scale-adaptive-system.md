# AIRchetipo Scale Adaptive System
...
AIRchetipo adapts to three distinct planning tracks:

- **Quick Flow**: Tech-spec only, implement immediately
- **AIRchetipo**: PRD + Architecture, structured approach
...
| **AIRchetipo**        | PRD + Arch + UX       | 1-3 days        | Products, platforms, complex features      |
...
flowchart TD
    ...
    START -->|Product, platform, complex| M[AIRchetipo<br/>PRD + Architecture]
...
- **AIRchetipo**: product, platform, dashboard, complex, multiple features
...
```
workflow-init: "Based on 'Add user dashboard with analytics', I recommend AIRchetipo.
...
Includes all AIRchetipo documents PLUS:
...
| **AIRchetipo** | Recommended | PRD + UX  | Required     | None         | 10-50+          |
...
### Scenario 3: Customer Portal (AIRchetipo)
...
### Scenario 4: E-commerce Platform (AIRchetipo)
...
If `workflow-init` suggests AIRchetipo, there's probably complexity you haven't considered. Review carefully before overriding.
...
For AIRchetipo and Enterprise, gate checks prevent costly mistakes. Invest the time.

### 5. Architecture is Optional but Recommended for Brownfield

Brownfield AIRchetipo makes architecture optional, but it's highly recommended. It distills complex codebase into focused solution design.
...
Product Brief is only offered for greenfield AIRchetipo and Enterprise. It's optional but helps with strategic thinking.
...
- Clear track purposes:
  ...
  - AIRchetipo = Product + system design
