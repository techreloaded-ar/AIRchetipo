# AIM Solutioning Workflows (Phase 3)
...
**Required for:** AIRchetipo (complex projects), Enterprise Method

**Optional for:** AIRchetipo (simple projects), Quick Flow (skip entirely)
...
graph TB
    ...
    subgraph AirEnterprise["<b>AIRchetipo METHOD + ENTERPRISE (Same Start)</b>"]
        direction TB
    ...
    FromPlanning -->|AIRchetipo<br/>or Enterprise| Architecture
    ...
    style AirEnterprise fill:#90caf9,stroke:#0d47a1,stroke-width:3px,color:#000
...
| -------------------------- | --------- | ------------------------------ | ------------------------------------------- |
| **architecture**           | Architect | AIRchetipo, Enterprise         | Technical architecture and design decisions |
| **solutioning-gate-check** | Architect | AIRchetipo Complex, Enterprise | Validate planning/solutioning completeness  |
...
- **AIRchetipo:** Multi-epic projects need architecture to prevent conflicts
- **Enterprise:** Same as AIRchetipo, plus optional extended workflows (test architecture, security architecture, devops strategy) added AFTER architecture but BEFORE gate check
...
- Multi-epic projects (AIRchetipo Complex, Enterprise)
...
- AIRchetipo Simple with straightforward tech stack
...
- **Always** before Phase 4 for AIRchetipo Complex and Enterprise projects
...
- AIRchetipo Simple (no gate check required)
...
```
Planning (prd by PM - same as AIRchetipo)
  → architecture (Architect)
...
**Note:** Enterprise uses the same planning and architecture as AIRchetipo. The only difference is optional extended workflows added AFTER architecture but BEFORE gate check.
...
Don't over-architect simple projects. AIRchetipo Simple projects need simple architecture.
...
- **Planning:** prd (PM) - same as AIRchetipo
...
**Key Difference:** Enterprise adds optional extended workflows AFTER architecture but BEFORE gate check. Everything else is identical to AIRchetipo.
...
- Use architecture for AIRchetipo and Enterprise (both required)
...
A: No. Quick Flow skips it. AIRchetipo and Enterprise both require it.

**Q: How do I know if I need architecture?**
A: If you chose AIRchetipo or Enterprise track in planning (workflow-init), you need architecture to prevent agent conflicts.
...
A: Only for Quick Flow. AIRchetipo and Enterprise both require gate check before Phase 4.
...
A: AIRchetipo: 1-2 days for architecture. Enterprise: 2-3 days total (1-2 days architecture + 0.5-1 day optional extended workflows). If taking longer, you may be over-documenting.
