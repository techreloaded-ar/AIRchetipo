# AIRchetipo V6 Quick Start Guide

Get started with AIRchetipo v6 for your new greenfield project. This guide walks you through building software from scratch using AI-powered workflows.
...
AIRchetipo (AIM) helps you build software through guided workflows with specialized AI agents. The process follows four phases:
...
3. **Phase 3: Solutioning** (Track-dependent) - Design the architecture for AIRchetipo and Enterprise tracks
...
The interactive installer will guide you through setup and create a `{air_folder}/` folder with all agents and workflows.
...
Workflows are interactive processes in V6 that replaced tasks and templates from prior versions. There are many types of workflows, and you can even create your own with the AIRchetipo Builder module. For the AIRchetipo, you'll be interacting with expert-designed workflows crafted to work with you to get the best out of both you and the LLM.
...
- **AIRchetipo** - Full planning (PRD + Architecture + UX) - products, platforms, complex features (typically 10-50+ stories)
- **Enterprise Method** - Extended planning (AIRchetipo + Security/DevOps/Test) - enterprise requirements, compliance, multi-tenant (typically 30+ stories)

**Note**: Story counts are guidance, not definitions. Tracks are chosen based on planning needs, not story math.

#### What gets created?

Once you confirm your track, the `aim-workflow-status.yaml` file will be created in your project's docs folder (assuming default install location). This file tracks your progress through all phases.

**Important notes:**

- Every track has different paths through the phases
- Story counts can still change based on overall complexity as you work
- For this guide, we'll assume a AIRchetipo track project
- This workflow will guide you through Phase 1 (optional), Phase 2 (required), and Phase 3 (required for AIRchetipo and Enterprise tracks)
...
1. **Start a new chat** with the specified agent (e.g., PM) - See [docs/ide-info](https://github.com/airchetipo-org/AIRchetipo/tree/main/docs/ide-info) for your IDE's specific instructions
...
**For AIRchetipo and Enterprise tracks:**
...
AIRchetipo creates two files to track your progress:

**1. aim-workflow-status.yaml**
...
A: Only for AIRchetipo and Enterprise tracks. Quick Flow projects skip straight from tech-spec to implementation.
...
- **Complete guide**: [AIM Workflow Documentation](./README.md#-workflow-guides)
- **YouTube tutorials**: [AIRchetipo Code Channel](https://www.youtube.com/@AIRchetipoCode)
...
✅ **Track matters** - Quick Flow uses tech-spec, AIRchetipo/Enterprise need PRD and architecture
