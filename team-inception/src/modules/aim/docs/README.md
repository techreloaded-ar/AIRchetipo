...
Complete guides for the AIRchetipo Module (AIM) - AI-powered agile development workflows that adapt to your project's complexity.
...
Understanding how AIM adapts to your needs:

- **[Scale Adaptive System](./scale-adaptive-system.md)** - How AIM adapts to project size and complexity (42 min read)
  - Three planning tracks (Quick Flow, AIRchetipo, Enterprise Method)
...
Complete guide to AIM's AI agent team:

- **[Agents Guide](./agents-guide.md)** - Comprehensive agent reference (45 min read)
  - 12 specialized AIM agents + AIRchetipo Master
...
- **[Party Mode Guide](./party-mode.md)** - Multi-agent collaboration (20 min read)
  ...
  - Multi-module integration (AIM + CIS + AIB + custom)
...
Comprehensive documentation for all AIM workflows organized by phase:
...
- **[Phase 2: Planning Workflows](./workflows-planning.md)** - Scale-adaptive planning (967 lines)
  ...
  - Track-based planning approach (Quick Flow, AIRchetipo, Enterprise Method)
...
- **[Phase 3: Solutioning Workflows](./workflows-solutioning.md)** - Architecture and validation (638 lines)
  ...
  - Required for AIRchetipo and Enterprise Method tracks
...
- **[Testing & QA Workflows](./test-architecture.md)** - Comprehensive quality assurance (1,420 lines)
  ...
  - AIRchetipo-integrated vs standalone modes
...
Understanding AIM components:

- **[AIM Module README](../README.md)** - Overview of module structure
