...
Quick Spec Flow is a **streamlined alternative** to the full AIRchetipo for Quick Flow track projects. Instead of going through Product Brief → PRD → Architecture, you go **straight to a context-aware technical specification** and start coding.
...
❌ **Use AIRchetipo or Enterprise tracks when:**
...
## Comparison: Quick Spec vs Full AIM

| Aspect                | Quick Flow Track             | AIRchetipo/Enterprise Tracks       |
| --------------------- | ---------------------------- | ---------------------------------- |
...
## When to Graduate from Quick Flow to AIRchetipo

Start with Quick Flow, but switch to AIRchetipo when:
...
💡 **Tip:** You can always run `workflow-init` later to transition from Quick Flow to AIRchetipo!
...
- AIRchetipo installed (`npx airchetipo install`)
...
**A:** No problem! You can always transition to AIRchetipo by running workflow-init and create-prd. Your tech-spec becomes input for the PRD.
...
- **Learn more:** See the [AIM Workflow Guides](./README.md#-workflow-guides) for comprehensive workflow documentation
