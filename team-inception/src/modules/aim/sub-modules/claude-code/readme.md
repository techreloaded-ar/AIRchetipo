# AIM Claude Code Sub-Module

## Overview

This sub-module provides Claude Code-specific enhancements for the AIM module, including specialized subagents and content injection for enhanced AI-assisted development workflows.

## How the Installer Works

When Claude Code is selected during AIRchetipo installation:
...
1. Run the AIRchetipo installer
2. Select AIM module and Claude Code
3. Verify prompts appear for subagent selection
4. Check `.claude/agents/` for installed subagents
5. Verify injection points are replaced in `.claude/commands/{air_folder}/` and the various tasks and templates under `{air_folder}/...`
