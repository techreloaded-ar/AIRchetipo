# AIRchetipo Agent Command Patterns Reference
...
<!-- Standard workflow -->
<item cmd="*create-prd"
     run-workflow="{project-root}/{air_folder}/aim/workflows/prd/workflow.yaml">
...
<item cmd="*validate-prd"
     ...
     workflow="{project-root}/{air_folder}/aim/workflows/prd/workflow.yaml">
...
<!-- Simple task -->
<item cmd="*validate"
   exec="{project-root}/{air_folder}/core/tasks/validate-workflow.xml">
  Validate document against checklist
</item>

<!-- Task with data -->
<item cmd="*standup"
   exec="{project-root}/{air_folder}/mmm/tasks/daily-standup.xml"
   data="{project-root}/{air_folder}/_cfg/agent-manifest.csv">
...
```xml
<item cmd="*brief"
   exec="{project-root}/{air_folder}/core/tasks/create-doc.md"
   tmpl="{project-root}/{air_folder}/aim/templates/brief.md">
  Produce Project Brief
</item>

<item cmd="*competitor-analysis"
   exec="{project-root}/{air_folder}/core/tasks/create-doc.md"
   tmpl="{project-root}/{air_folder}/aim/templates/competitor.md"
   data="{project-root}/{air_folder}/_data/market-research.csv">
...
<item cmd="*list-tasks"
   action="list all tasks from {project-root}/{air_folder}/_cfg/task-manifest.csv">
...
<agent name="Research Assistant">
  ...
  <menu>
    ...
    <item cmd="*review-literature"
       ...
       data="{project-root}/{air_folder}/_data/sources.csv">
...
<!-- Workflow with data -->
<item cmd="*brainstorm"
   run-workflow="{project-root}/{air_folder}/core/workflows/brainstorming/workflow.yaml"
   data="{project-root}/{air_folder}/core/workflows/brainstorming/brain-methods.csv">
...
<item cmd="*analyze-metrics"
   ...
   data="{project-root}/{air_folder}/_data/performance-metrics.json">
...
<item cmd="*report"
   exec="{project-root}/{air_folder}/core/tasks/create-doc.md"
   tmpl="{project-root}/{air_folder}/aim/templates/report.md"
   data="{project-root}/{air_folder}/_data/quarterly-results.csv">
...
3. *create-agent - Build new AIRchetipo agent
...
<item cmd="*{action}-{object}"
   run-workflow="{project-root}/{air_folder}/{module}/workflows/{workflow}/workflow.yaml">
...
<item cmd="*validate-{object}"
   validate-workflow="{output_folder}/{document}.md"
   workflow="{project-root}/{air_folder}/{module}/workflows/{workflow}/workflow.yaml">
...
```xml
<item cmd="*{action}"
   exec="{project-root}/{air_folder}/{module}/tasks/{task}.md">
  {Action Description}
</item>
```
...
<item cmd="*{document}"
   exec="{project-root}/{air_folder}/core/tasks/create-doc.md"
   tmpl="{project-root}/{air_folder}/{module}/templates/{template}.md">
...
<agent id="{air_folder}/research/agents/analyst.md" name="Research Analyst" icon="🔬">
  ...
  <menu>
    ...
    <item cmd="*compete"
       ...
       data="{project-root}/{air_folder}/_data/market-data.csv">
      Analyze Competition
    </item>
    ...
    <item cmd="*report"
       exec="{project-root}/{air_folder}/core/tasks/create-doc.md"
       tmpl="{project-root}/{air_folder}/research/templates/report.md">
...
<agent name="Data Analyst">
  <menu>
    ...
    <item cmd="*analyze"
       ...
       data="{project-root}/{air_folder}/_data/dataset.csv">
      Analyze Dataset
    </item>
