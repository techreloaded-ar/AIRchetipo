...
_Context provided to brainstorming workflow when creating a new AIRchetipo agent_

## Session Focus

You are brainstorming ideas for a **AIRchetipo agent** - an AI persona with specific expertise, personality, and capabilities that helps users accomplish tasks through commands and workflows.

## What is a AIRchetipo Agent?
...
A great AIRchetipo agent should be:
...
_This focused context helps create distinctive, useful AIRchetipo agents_
