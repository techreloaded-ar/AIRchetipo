...
Interactive agent builder creating AIRchetipo Core compliant agents as YAML source files that compile to .md during installation.
...
- Source: `{air_folder}/agents/{filename}.agent.yaml`
- Compiled: `{air_folder}/agents/{filename}.md`

**Module Agents:**

- Source: `src/modules/{module}/agents/{filename}.agent.yaml`
- Compiled: `{air_folder}/{module}/agents/{filename}.md`
...
agent:
  metadata:
    id: {air_folder}/{module}/agents/{filename}.md
    name: Agent Name
    title: Agent Title
    icon: 🤖
    module: module-name
...
Location: `{air_folder}/_cfg/agents/{module}-{filename}.customize.yaml`
...
```bash
node tools/cli/air-cli.js compile-agents
```
