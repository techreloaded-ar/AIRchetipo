...
<critical>You MUST have already loaded and processed: {project-root}/src/modules/aib/workflows/redoc/workflow.yaml</critical>
...
<step n="1" goal="Load AIRchetipo conventions and initialize">
<action>Load ALL AIRchetipo convention documents from {air_conventions}:
...
2. Synthesize understanding:
   ...
   - Input requirements
   - Output produced
   - Unique characteristics (vs standard AIRchetipo workflow patterns)
...
3. Identify module's unique purpose within AIRchetipo ecosystem
...
4. Generate/update module README.md:
   ...
   Focus on UNIQUE aspects using AIRchetipo convention knowledge:
   - Don't explain standard AIRchetipo patterns
   - Highlight what makes THIS module distinctive
   - Use proper AIRchetipo terminology
