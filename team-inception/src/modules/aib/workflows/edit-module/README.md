...
Interactive workflow for editing existing AIRchetipo modules, including structure, agents, workflows, configuration, and documentation.

## Purpose

This workflow helps you improve and maintain AIRchetipo modules by:
...
A proper AIRchetipo module has:
...
```yaml
# In agent menu item:
workflow: '{project-root}/{air_folder}/other-module/workflows/shared-workflow/workflow.yaml'
```

Common patterns:

- AIM uses CIS brainstorming workflows
...
**Installed modules** (in {air_folder}/):
...
```
User: I want to add a new workflow to AIM for API design
Workflow: Analyzes AIM → You choose option 8 (add new workflow)
...
Invoke via AIRchetipo Builder agent:

```
/air:aib:agents:air-builder
...
- **AIM Module** - Example of full-featured module
- **AIB Module** - Example of builder/tooling module
