...
Use this checklist to validate module edits meet AIRchetipo standards.

## Module Structure Validation

- [ ] Module has clear 3-letter code (aim, aib, cis, etc.)
- [ ] Module is in correct location (src/modules/ for source, {air_folder}/ for installed)
- [ ] agents/ directory exists
- [ ] workflows/ directory exists
- [ ] config.yaml exists in module root
- [ ] README.md exists in module root
- [ ] Directory structure follows AIRchetipo conventions
...
- [ ] README explains module's role in AIRchetipo ecosystem
...
- [ ] Paths are {air_folder}/-relative (not project-root)
