...
<critical>You MUST have already loaded and processed: {project-root}/{air_folder}/aib/workflows/edit-module/workflow.yaml</critical>
...
<ask>What is the path to the module you want to edit? (provide path to module directory like {air_folder}/aim/ or src/modules/aim/)</ask>
...
- Study reference modules: AIM, AIB, CIS
- Understand AIRchetipo module patterns and conventions
  </action>

<action>Analyze the module deeply:

- Identify module purpose and role in AIRchetipo ecosystem
...
- What this module provides (its purpose and value in AIRchetipo)
- How it's organized (agents, workflows, structure)
- What you notice (strengths, potential improvements, issues)
- How it fits in the larger AIRchetipo ecosystem
...
- Show how to reference workflows properly: {project-root}/{air_folder}/{{module}}/workflows/{{workflow}}/workflow.yaml
...
- "Looking at how AIM organized this, we could use {{approach}}"
- "The AIRchetipo convention is to {{pattern}} which helps with {{benefit}}"

Connect improvements to broader AIRchetipo principles without being preachy.
</action>
...
If this is part of larger AIRchetipo work:
