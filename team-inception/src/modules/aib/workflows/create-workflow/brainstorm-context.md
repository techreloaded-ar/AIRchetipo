...
_Context provided to brainstorming workflow when creating a new AIRchetipo workflow_

## Session Focus

You are brainstorming ideas for a **AIRchetipo workflow** - a guided, multi-step process that helps users accomplish complex tasks with structure, consistency, and quality.

## What is a AIRchetipo Workflow?
...
A great AIRchetipo workflow should be:
...
_This focused context helps create valuable, structured AIRchetipo workflows_
