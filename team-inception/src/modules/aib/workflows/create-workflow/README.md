...
The Build Workflow is an interactive workflow builder that guides you through creating new AIRchetipo workflows with proper structure, conventions, and validation. It ensures all workflows follow best practices for optimal human-AI collaboration and are fully compliant with the AIRchetipo v6 workflow execution engine.
...
- **Convention Enforcement**: Ensures adherence to AIRchetipo workflow creation guide
...
### Through AIRchetipo Builder Agent
...
`{project-root}/{air_folder}/{{target_module}}/workflows/{{workflow_name}}/`
...
- AIRchetipo v6 project structure
- Module to host the new workflow (aim, aib, cis, or custom)
...
- **v6.0.0** - Initial AIRchetipo v6 compatible version
...
- Review `/{air_folder}/aib/workflows/create-workflow/workflow-creation-guide.md`
- Check existing workflows in `/{air_folder}/aim/workflows/` for examples
- Validate against `/{air_folder}/aib/workflows/create-workflow/checklist.md`
- Consult AIRchetipo Method v6 documentation

---

_Part of the AIRchetipo v6 - AIB (AIRchetipo Builder) Module_
