# AIRchetipo Workflow Creation Guide

Create structured, repeatable workflows for human-AI collaboration in AIRchetipo v6.
...
installed_path: '{project-root}/{air_folder}/module/workflows/my-workflow'
...
That's it! To execute, tell the AIRchetipo agent: `workflow path/to/my-workflow/`
...
| **Location**   | `/src/core/tasks/` | `/{air_folder}/*/workflows/` |
...
# Paths
installed_path: '{project-root}/{air_folder}/module/workflows/name'
...
aim/workflows/plan-project/workflow.yaml → standalone: true
aim/workflows/architecture/workflow.yaml → standalone: true

# Helper workflows: standalone: false
aim/workflows/internal/validate-epic/workflow.yaml → standalone: false
aim/workflows/internal/format-story/workflow.yaml → standalone: false
```
...
**Intent-based workflows give the AI goals and principles, letting it adapt the conversation naturally to the user's context.** This is the AIRchetipo v6 default for most workflows.
...
- Not part of AIRchetipo workflow spec
...
- All AIM workflows support both whole and sharded documents
...
- Full Load: `src/modules/aim/workflows/2-plan-workflows/prd/`
- Selective Load: `src/modules/aim/workflows/4-implementation/epic-tech-context/`
...
4. **Relative Paths**: Use `{air_folder}/` root paths (no `{project-root}`)
...
web_bundle:
  ...
  # Core files ({air_folder}/-relative paths)
  instructions: '{air_folder}/module/workflows/workflow/instructions.md'
  validation: '{air_folder}/module/workflows/workflow/checklist.md'
  template: '{air_folder}/module/workflows/workflow/template.md'

  # Data files (no config_source allowed)
  data_file: '{air_folder}/module/workflows/workflow/data.csv'

  # Complete file list - CRITICAL!
  web_bundle_files:
    - '{air_folder}/module/workflows/workflow/instructions.md'
    - '{air_folder}/module/workflows/workflow/checklist.md'
    - '{air_folder}/module/workflows/workflow/template.md'
    - '{air_folder}/module/workflows/workflow/data.csv'
...
1. **Remove Config Dependencies**:
   ...
   - Convert `{project-root}/{air_folder}/` to `{air_folder}/`
...
3. **Test Completeness**:
   ...
   - Verify all paths are relative to {air_folder}/
...
web_bundle:
  ...
  author: 'AIRchetipo Team'

  instructions: '{air_folder}/aim/workflows/analyze-requirements/instructions.md'
  validation: '{air_folder}/aim/workflows/analyze-requirements/checklist.md'
  template: '{air_folder}/aim/workflows/analyze-requirements/template.md'

  # Data files
  techniques_data: '{air_folder}/aim/workflows/analyze-requirements/techniques.csv'
  patterns_data: '{air_folder}/aim/workflows/analyze-requirements/patterns.json'

  # Sub-workflow reference
  validation_workflow: '{air_folder}/aim/workflows/validate-requirements/workflow.yaml'

  standalone: true

  web_bundle_files:
    # Core workflow files
    - '{air_folder}/aim/workflows/analyze-requirements/instructions.md'
    - '{air_folder}/aim/workflows/analyze-requirements/checklist.md'
    - '{air_folder}/aim/workflows/analyze-requirements/template.md'

    # Data files
    - '{air_folder}/aim/workflows/analyze-requirements/techniques.csv'
    - '{air_folder}/aim/workflows/analyze-requirements/patterns.json'

    # Sub-workflow and its files
    - '{air_folder}/aim/workflows/validate-requirements/workflow.yaml'
    - '{air_folder}/aim/workflows/validate-requirements/instructions.md'
    - '{air_folder}/aim/workflows/validate-requirements/checklist.md'

    # Shared templates referenced in instructions
    - '{air_folder}/aim/templates/requirement-item.md'
    - '{air_folder}/aim/templates/validation-criteria.md'
```
...
- `/{air_folder}/aim/workflows/` - Production examples
