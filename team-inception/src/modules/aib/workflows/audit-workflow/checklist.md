...
- [ ] All paths in web_bundle use {air_folder}/-relative format (NOT {project-root})
...
- [ ] existing_workflows maps workflow variables to {air_folder}/-relative paths correctly
...
**Auditor:** Audit Workflow (AIRchetipo v6)
