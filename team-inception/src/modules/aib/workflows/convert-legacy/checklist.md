...
- [ ] ALL paths reference {project-root}/{air_folder}/{{module}}/ locations, NOT src/
- [ ] exec, data, run-workflow commands point to final AIRchetipo installation paths
...
- [ ] Elicitation points (elicit: true) converted to <invoke-task halt="true">{project-root}/{air_folder}/core/tasks/advanced-elicitation.xml</invoke-task>
