...
<critical>You MUST have already loaded and processed: {project-root}/{air_folder}/aib/workflows/edit-workflow/workflow.yaml</critical>
...
- Study example workflows from: {project-root}/{air_folder}/aim/workflows/
  </action>
...
- Verify paths are {air_folder}/-relative
...
- "Looking at examples in AIM, this type of step usually {{approach}}"
