...
<critical>You MUST have already loaded and processed: {project-root}/{air_folder}/aib/workflows/module-brief/workflow.yaml</critical>
...
- Other AIRchetipo modules it might use
