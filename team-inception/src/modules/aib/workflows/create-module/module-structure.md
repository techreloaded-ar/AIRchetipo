# AIRchetipo Module Structure Guide

## What is a Module?

A AIRchetipo module is a self-contained package of agents, workflows, tasks, and resources that work together to provide specialized functionality. Think of it as an expansion pack for the AIRchetipo Method.
...
```
# SOURCE MODULE (in AIRchetipo project)
...
{project-root}/{air_folder}/{module-code}/
...
menu:
  - trigger: command-name
    workflow: '{project-root}/{air_folder}/SOURCE_MODULE/workflows/path/workflow.yaml'
    workflow-install: '{project-root}/{air_folder}/THIS_MODULE/workflows/vendored/workflow.yaml'
...
data_path:
  result: '{project-root}/{air_folder}/module-code/data'
```
