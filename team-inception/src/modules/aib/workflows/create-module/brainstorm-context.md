...
_Context provided to brainstorming workflow when creating a new AIRchetipo module_

## Session Focus

You are brainstorming ideas for a **complete AIRchetipo module** - a self-contained package that extends the AIRchetipo Method with specialized domain expertise and capabilities.

## What is a AIRchetipo Module?
...
A good AIRchetipo module should be:
...
_This focused context helps create cohesive, valuable AIRchetipo modules_
