...
async function runTests() {
  ...
  try {
    ...
    const pmAgentPath = path.join(projectRoot, 'src/modules/aim/agents/pm.agent.yaml');
  ...
  try {
    ...
    const testPath = '{project-root}/air/aim/config.yaml';
    const expectedPattern = /\/air\/aim\/config\.yaml$/;
